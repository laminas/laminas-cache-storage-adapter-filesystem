    ...
    TotalSpaceCapableInterface
{
    ...
    {
        ErrorHandler::start();
        $unlinkFromUnitTest = sprintf('%s\\unlink', __NAMESPACE__);
        $res                = function_exists($unlinkFromUnitTest) ? $unlinkFromUnitTest($file) : unlink($file);
        $err                = ErrorHandler::stop();
